...
trainset <- sea_datastream$get_points(sea_datastream, n = 15000, outofpoints = c("stop", "warn", "ignore"))
...
testset <- sea_test_datastream$get_points(sea_test_datastream, n = 15000, outofpoints = c("stop", "warn", "ignore"))
